...
!                       dta_bdy(jbdy)%sal(ib,ik) = tsn(ii,ij,ik,jp_sal) * tmask(ii,ij,ik) 
                        dta_bdy(jbdy)%tem(ib,ik) = 10.0 !tsn(ii,ij,ik,jp_bdytem) * tmask(ii,ij,ik)         
                        dta_bdy(jbdy)%sal(ib,ik) = 33.0 !tsn(ii,ij,ik,jp_bdysal) * tmask(ii,ij,ik)    
                      !   if (ik == 1) then
                      !    write(100+nproc,*) ii,ij,tsn(ii,ij,ik,jp_bdytem),tsn(ii,ij,ik,jp_bdysal), tmask(ii,ij,ik)
                      !    call flush(100+nproc)
                      !   endif     
